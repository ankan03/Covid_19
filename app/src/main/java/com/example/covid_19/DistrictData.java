...
public class DistrictData {
    ...
    public DistrictData(String state, String statecode, String district, String confirmed, String todayConfirmed, String deceased, String todayDeceased, String recovered, String todayRecovered, String active) {
        this.state = state;
